<template>
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="#"> <img src="https://i.imgur.com/DJZ5Dnk.jpg" /> Vue Store</a>
      </li>
    </ul>
  </nav>
  <div id="app">
    <div class="container container-space">
      <div class="row">
          ...
          <div class="product-thumbnails">
            <ul>
              <li
                ...
                :key="index"
              >
                <img @click="currentThumnail(image.imageUrl, index)" :src="image.imageUrl" alt="" />
              </li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          ...
          <ul v-for="(detail, index) in productChecks" :key="index">
            <li>{{ detail }}</li>
          </ul>
...
export default {
  data() {
    return {
      ...
      productPrice: "$20",
      productChecks: ["100% cotton on the neckline", "certified and safe", "ash in color", "Smooth in quality"],
